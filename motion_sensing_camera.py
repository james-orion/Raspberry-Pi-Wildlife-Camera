...
filename1 = ('~/Desktop/CS2210/FINAL_PROJECT/images/' + dt_string + '.jpeg')
camera.capture(filename1)
print("Image Captured") #line to make sure the motion sensing is working

sleep(1)
dt_string = datetime.now().strftime('%d_%m_%Y_%H.%M.%S')
filename2 = ('home/james/Desktop/CS2210/FINAL_PROJECT/images/' + dt_string + '.jpeg')
camera.capture(filename2)
print("Image Captured")

sleep(1)
dt_string_3 = datetime.now().strftime('%d_%m_%Y_%H.%M.%S')
filename3 = ('home/james/Desktop/CS2210/FINAL_PROJECT/images/' + dt_string + '.jpeg')
